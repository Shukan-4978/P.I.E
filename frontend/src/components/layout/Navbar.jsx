                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    {searchResults.users.map((u) => (
                      <div key={u._id} onClick={() => { navigate(`/profile/${u._id}`); setSearchOpen(false); }} className="nav-item" style={{ padding: '0.75rem', borderRadius: '12px', gap: '1rem' }}>
                        <img src={u.avatar ? `${u.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(u.name)}&background=6366f1&color=fff`} alt="" style={{ width: '40px', height: '40px', borderRadius: '12px', objectFit: 'cover' }} />
                        <div style={{ flex: 1 }}>
                  ...
                  <div style={{ marginBottom: searchResults?.investments?.length ? '1.5rem' : 0 }}>
                    ...
                    {searchResults.startups.map((s) => (
                      <div key={s._id} onClick={() => { navigate(`/startups/${s._id}`); setSearchOpen(false); }} className="nav-item" style={{ padding: '0.75rem', borderRadius: '12px', gap: '1rem' }}>
                        {s.logo ? (
                          <img src={`${s.logo}`} alt="" style={{ width: '40px', height: '40px', borderRadius: '12px', objectFit: 'cover' }} />
                        ) : (
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
        ...
        <div ref={userMenuRef} style={{ position: 'relative' }}>
          ...
          >
            <div style={{ position: 'relative' }}>
              <img
                src={user?.avatar ? `${user.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'U')}&background=6366f1&color=fff`}
            ...
            {userMenuOpen && (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.5rem', marginBottom: '1rem' }}>
                  <img src={user?.avatar ? `${user.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'U')}&background=6366f1&color=fff`} alt="" style={{ width: '44px', height: '44px', borderRadius: '14px', objectFit: 'cover' }} />
