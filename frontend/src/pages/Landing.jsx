...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch('http://localhost:5000/api/startups/public/stats').then(r => r.json()),
      fetch('http://localhost:5000/api/startups/public/list').then(r => r.json()),
      fetch('http://localhost:5000/api/auth/public/investors').then(r => r.json()),
