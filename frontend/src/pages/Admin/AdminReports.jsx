                    ...
                    <div style={{ background: 'var(--bg-secondary)', padding: '1rem', borderRadius: '16px', border: '1px solid var(--border)' }}>
                      {r.type === 'user' && r.reportedUser && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                          <img src={r.reportedUser.avatar ? `${r.reportedUser.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(r.reportedUser.name)}`} style={{ width: '40px', height: '40px', borderRadius: '50%' }} alt="" />
                          <div>
