                ...
                <tr key={a._id} style={{ borderBottom: '1px solid var(--border)', transition: 'background 0.2s' }} onMouseOver={e => e.currentTarget.style.background = 'var(--bg-secondary)'} onMouseOut={e => e.currentTarget.style.background = 'none'}>
                  <td style={{ padding: '1rem 1.25rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                      <img src={a.uploadedBy?.avatar ? `${a.uploadedBy.avatar}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(a.uploadedBy?.name || 'U')}&background=6366f1&color=fff`} style={{ width: '32px', height: '32px', borderRadius: '8px' }} alt="" />
                      <div>
                  ...
                  <td style={{ padding: '1rem 1.25rem' }}>
                    <a href={`${a.pitchDeckUrl}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#6366f1', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 500 }}>
                      <FileText size={14} />
