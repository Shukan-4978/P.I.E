            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                  {s.logo ? (
                    <img src={`${s.logo}`} alt="" style={{ width: '64px', height: '64px', borderRadius: '18px', objectFit: 'cover', border: '1px solid var(--border)', padding: '4px', background: 'var(--bg-primary)' }} />
                  ) : (
